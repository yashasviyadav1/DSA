...
/*  Approach - 2 (Tabulation + SpaceOptimizaiton + partitionWithKSum logic)
...
*/
    public static int minSubsetSumDifference(int []arr, int n) {
        ...
        prev[0] = true; // base cases- if target is 0 it is achieved
        ...
        for(int index=1; index < n; index++){// all index 0's cells are covered
            ...
            curr[0] = true;// base cases- if target is 0 it is achieved
